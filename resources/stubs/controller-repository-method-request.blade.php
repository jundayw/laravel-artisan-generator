...
class DummyControllerClass extends Controller
{
     ...
     * @action 保存DummyLabel
     *
     * @param DummyRequestClass1 $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function store(DummyRequestClass1 $request)
    {
     ...
     * @action 更新DummyLabel
     *
     * @param DummyRequestClass2 $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function update(DummyRequestClass2 $request)
    {
